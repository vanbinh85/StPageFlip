...
export class PDFPage extends Page {
    ...
    constructor(render: Render, distElement: HTMLElement, density: PageDensity) {
        super(render, density);
        this.distElement = distElement;
        this.element = document.createElement('div');
        this.element.classList.add('page', 'stf__item');
    ...
    public newTemporaryCopy(): Page {
        ...
        if (this.temporaryCopy === null) {
            ...
            this.temporaryCopy = new PDFPage(
                this.render,
                this.copiedElement,
